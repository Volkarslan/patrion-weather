...
export default function Application() {
    ...
    // Function to track user input for city search
    const trackSearch = (e) => {
        e.preventDefault();
    ...
    return (
        <div className="relative isolate overflow-hidden bg-gray-900 px-12 py-24 sm:py-32 lg:hidden" id="application-mobile">
            ...
            <div className="relative text-center mx-auto max-w-7xl px-6 lg:px-8 bg-gray-900/50 rounded-xl p-6 min-h-[40rem]">
                <div className="mx-auto lg:mx-0">
                    ...
                    <p className="mt-6 text-lg leading-8 text-gray-300">
                        {localization.application.description_search}
                    </p>
                </div>
                ...
                <div>
                    <form className="mt-5 sm:flex sm:items-center justify-center">
                        ...
                        <button
                            ...
                            className="mt-3 inline-flex w-full items-center justify-center rounded-md bg-cyan-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-cyan-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600 sm:ml-3 sm:mt-0 sm:w-auto max-w-[10rem]"
                        >
                        ...
                        <button
                            onClick={clearSearch}
                            className="mt-3 inline-flex w-full items-center justify-center rounded-md bg-sky-800 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-sky-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-700 sm:ml-3 sm:mt-0 sm:w-auto ml-2 max-w-[2rem]"
                        >
